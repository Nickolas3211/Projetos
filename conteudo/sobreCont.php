...
<body class="fundoSobre">
    ...
    <!--SOBRE-->
    <section class="sobre">
        <h2 class="wow animate__animated animate__bounceInDown">Sobre a nossa empresa</h2>
        <div class="site wow animate__animated animate__bounceInUp"">
            <img src="img/img_faixada.png" alt="imagem da fundadora da empresa">
