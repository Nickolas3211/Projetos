...
<body>
    ...
    <!--EQUIPE-->
    <section class="equipe e_licakes">
        <h2 class="wow animate__animated animate__bounceInDown">Equipe da LiCakes</h2>
        <div class="site wow animate__animated animate__bounceInUp"">
            ...
            <img src="img/e_Licakes.png" alt="imagem da fundadora da empresa">
        </div>
    </section>
    <section class="equipe e_system">
        <h2 class="wow animate__animated animate__bounceInDown">Equipe da System Maker</h2>
        <div class="site wow animate__animated animate__bounceInUp"">
            <img src="img/e_system.png" alt="imagem da fundadora da empresa">
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
                industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type
                and scrambled it to make a type specimen book. It has survived not only five centuries, but also the
                leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s
